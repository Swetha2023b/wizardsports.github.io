      ...
      <div class="navbar-default sidebar" role="navigation">
          <div class="sidebar-nav navbar-collapse">
              <ul class="nav" id="side-menu">
                  <li>
                      <a href="stu_index.php"><i class="fa fa-dashboard fa-fw nav_icon"></i>Home</a>
                  </li>

                  <li>
                      <a href="#"><i class="fa fa-indent nav_icon"></i>Notifications</a>
                  </li>
                  <li>
                      <a href="#"><i class="fa fa-sitemap fa-fw nav_icon"></i>Complaints</a>
                  </li>
                  
                  <li>
                      <a href="#"><i class="fa fa-check-square-o nav_icon"></i>Mailbox</span></a>
                  </li>
                  
                  <li>
                      <a href="#"><i class="fa fa-laptop nav_icon"></i>Checkup Appointment</a>
                  </li>
