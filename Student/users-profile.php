...
<?php 
  ...
  $getdetails1 = "SELECT * FROM tbl_stud_address WHERE login_id = $log_id";
  $result1 = mysqli_query($db, $getdetails1);
  $row1 = mysqli_fetch_assoc($result1);
  // $item1 = $row['stud_item'];
  $name = $row['stud_name'];
  $address1 = $row1['stud_housenm'];
  $address2 = $row1['stud_area'];
  $address3 = $row1['stud_city'];
  $phone = $row['stud_phone'];
  $state = $row1['stud_state'];
  $dob = $row['stud_dob'];
...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="../Upload/<?php echo $row['stud_image']; ?>" alt="Profile" class="rounded-circle">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="users-profile.html">Home</a></li>
      ...
      <div class="row">
        <div class="col-xl-4">
          ...
          <div class="card">
            ...
            <!-- <?php echo"<script Type='text/javascript'>alert($stud_image)</script>";   ?> -->
              <img src="../Upload/<?php echo $row['stud_image']; ?>" alt="Profile" class="rounded-circle">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <?php
                    ...
                    ?>
                      <div class="row">
                        <div class="col-lg-3 col-md-4 label">Sports Category</div>
                    ...
                    ?>
                      <div class="row">
                        <div class="col-lg-3 col-md-4 label">Sports Categories</div>
                        <div class="col-lg-9 col-md-8"><?php echo $item1 ?></div>
                      </div>
                      <div class="row">
                        <div class="col-lg-3 col-md-4 label"></div>
                        <div class="col-lg-9 col-md-8"><?php echo $item2 ?></div>
                      </div>
                    <?php
                    }
                    ?>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form action="../Coach/changepass.php" method="POST" onsubmit="return validateForm();">
...
function validateForm() {
   ...
   var password2 = document.getElementById("renewpass").value;
