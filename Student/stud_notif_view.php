<!-- $output .= '  
        <tr>  
          ...
          <td>' . $row["tour_matter"] . '<br>
              Tournament start date: ' . $row["tour_start_date"] . '<br>
              Tournament end date: ' . $row["tour_end_date"] . '<br>
              Venue: ' . $row["tour_college"] . '<br>
              Place: ' . $row["tour_place"] . '<br>
              The list of the students is: ' . $row["word"] . '
          </td>  
        </tr>    
      ';  -->
...
{
    $output = '';
    $getdetails = "SELECT * FROM tbl_tournament WHERE tour_id = '".$_POST["tour_id"]."'";
    // $no = $_POST["tour_id"];
  ...
  <?php
    ...
    {  
        ...
        <tr style="justify-content: center;">  
          <td style="font-weight: bold;">' . $row["tour_matter"] . '</td>
        </tr>
        <tr style="text-align: left;">
          <td>Tournament start date : ' . $row["tour_start_date"] . '</td>
        </tr>
        <tr style="text-align: left;">
          <td>Tournament end date : ' . $row["tour_end_date"] . '</td>
        </tr>
        <tr style="text-align: left;">
          <td>Venue : ' . $row["tour_college"] . '</td>
        </tr>
        <tr style="text-align: left;">
          <td>Place : ' . $row["tour_place"] . '</td>
        </tr>
        <tr style="text-align: left;">
          <td>Instructions : ' . $row["tour_instructions"] . '</td>
        </tr>    
      ';
    }
    // The list of the students is: ' . $row["word"] . '
