     ...
     <thead>
      ...
      <?php  while ($row = mysqli_fetch_array($result)) { ?>
                    <tr>
                        ...
                        <td><?php echo $row['contactee_name']; ?></td>
                        <td><a href="mailto:<?php echo $row['contactee_mail']; ?>"><?php echo $row['contactee_mail']; ?></a></td>
                        <td><?php echo $row['contactee_number']; ?></td>
                        <td><?php if (strlen($row['contactee_message']) > 15) {
							$truncated_message = substr($row['contactee_message'], 0, 15) . '...';
							} else {
								$truncated_message = $row['contactee_message'];
							}
							$truncated_message; 
							echo $truncated_message;?></td>
						<td><button class="btn btn-primary btn-lg"  id="<?php echo $row['contact_id'] ?>" >View</a></button> </td>
                        </tr>   
        <?php } ?>
